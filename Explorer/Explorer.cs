...
namespace Explorer
{
	class Explorer
	{
		...
		public Explorer(int minPosition, int maxPosition)
		{
		...
		public static void Exp()
		{
			...
			Explorer e = new Explorer(minPosition: 0, maxPosition: 2);
			show.ShowDrives(drives, position, old_position);
			...
			while (true)
			{
				...
				switch (key.Key)
				{
					case ConsoleKey.UpArrow:
						if (page == 5 && position > e.minPosition)
						{
							position--;
							show.ShowDrives(drives, position, old_position);
							old_position--;
					...
					case ConsoleKey.DownArrow:
						if (page == 5 && position < e.maxPosition)
						{
							position++;
							show.ShowDrives(drives, position, old_position);
							old_position++;
					...
					case ConsoleKey.Enter:
						...
						page = position;
						page = 1;
						show.ShowFiles(drives, position, old_position, page);
						position = 0;
						old_position = 0;
						page = 5;
						break;
